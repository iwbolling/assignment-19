...
function pageGen() {
  ...
  var givenProfile = void 0;
  if (currentRoute === "") {
    givenProfile = "iwbolling";
  } else {
    givenProfile = currentRoute.slice(1);
  }
  _profileInfoGen(givenProfile, _secrets.githubApiKey);
  _repoInfoGen(givenProfile, _secrets.githubApiKey);
};
pageGen();
function _profileInfoGen(givenProfile, githubApiKey) {
  var profileInfo = _jquery2.default.getJSON("https://api.github.com/users/" + givenProfile + "?access_token=" + githubApiKey).then(function (serverRes) {
...
function _repoInfoGen(givenProfile, githubApiKey) {
  var repoInfo = _jquery2.default.getJSON("https://api.github.com/users/" + givenProfile + "/repos?access_token=" + githubApiKey).then(function (serverRes) {
