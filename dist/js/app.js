...
// SUPER
// SECRET
var githubApiKey = exports.githubApiKey = "6b0f09ee213f0b2ed7de3b942957a1feb0639f64";
...
function _profileInfoGen(givenProfile) {
  var profileInfo = _jquery2.default.getJSON("https://api.github.com/users/" + givenProfile + "?access_token=" + _secrets.githubApiKey).then(function (serverRes) {
...
function _repoInfoGen(givenProfile) {
  var repoInfo = _jquery2.default.getJSON("https://api.github.com/users/" + givenProfile + "/repos?access_token=" + _secrets.githubApiKey).then(function (serverRes) {
    var genRepos = serverRes.map(function (repo) {
